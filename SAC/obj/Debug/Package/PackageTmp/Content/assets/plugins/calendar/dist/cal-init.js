...
!function($) {
    ...
    CalendarApp.prototype.onEventClick = function (calEvent, jsEvent, view) {
        ...
        var $this = this;
            ...
            var form = $("<form></form>");
            form.append("<label>Modificar nombre de evento</label>");
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        ...
        form.append("<div class='row'><div class='col-md-6'>" +
                    "<h6 class= 'box-title m-t-30' > Fecha</h6>" +           
                    "<div class='input-group'>" +
                    "<input type='text' class='form-control' id='datepicker-autoclose' placeholder='mm/dd/yyyy'>" +
                    "<span class='input-group-addon'><i class='icon-calender'></i></span> </div>" +
                    "</div>" +
                    "<div class='col-md-6'>" +
                    "<h6 class='box-title m-t-30'>Hora</h6>" +
                    "<div class='input-group clockpicker ' data-placement='bottom' data-align='top' data-autoclose='true'>" +
            "<input type='text' id='time' class='form-control' value='08:00'> <span class='input-group-addon'> <span id='btnClok' class='fa fa-clock-o'></span> </span>" +
                    "</div>" +
                    "</div></div>"); 
            ...
            $this.$modal.find('form').on('submit', function () {
                ...
                if (title !== null && title.length != 0) {
                    ...
                    alert('Ingresa un Nombre a tu evento.');
                }
                return false;
    ...
    CalendarApp.prototype.init = function() {
        ...
        var defaultEvents =  [{
                ...
                title: 'Esta es la fecha de verificación de hoy.',
                start: today,
                end: today,
                className: 'bg-danger'
            }, {

...
/* An abstract class for all SAC-related views. Displays one more columns with time slots running vertically.
----------------------------------------------------------------------------------------------------------------------*/
...
var AgendaView = FC.AgendaView = View.extend({
	...
	renderDates: function() {
		...
		this.el.addClass('fc-SAC-view').html(this.renderSkeletonHtml());
		this.renderHead();
